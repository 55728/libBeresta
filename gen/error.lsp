...
(:элемент "BRST_ARRAY_COUNT_ERR"             :ru "" :en "" :значение "0x1001")
(:элемент "BRST_ARRAY_ITEM_NOT_FOUND"        :ru "" :en "" :значение "0x1002")
(:элемент "BRST_ARRAY_ITEM_UNEXPECTED_TYPE"  :ru "" :en "" :значение "0x1003")
